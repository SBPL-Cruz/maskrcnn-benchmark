...
def run_6d():
    ...
    # for img_i in [11]:
        ...
        # ratios in losses
        # reduce confidence
        # try with descretization in ssd paper
        ...
        # try with lazy
        # why is centroid in 2d - calculate centroid of mask. check if centroid of generated poses is actually at object center, 11, 12

        # after fixing rousre cost : 00 getting messed up, maybe because of getsuccs hack
...
def run_sameshape():
    ...
    # for img_i in list(range(0,13)) + ['30', '31', '34', '35', '36', '37', '39', '40', '15', '16', '17', '18', '19', '21', '22', '23', '24', '26', '27', '28', '29', '41', '42', '43', '44', '45', '46', '47', '49']:
        ...
        f_accuracy.write("{} ".format(image_data['file_name']))
        accuracy_dict = fat_image.compare_clouds(transformed_annotations, perch_annotations, downsample=False, use_add_s=False)
        for object_name in required_objects:
            f_accuracy.write("{} ".format(accuracy_dict[object_name]))
        f_accuracy.write("\n")
